...
class AccountController extends CI_Controller
{
    ...
    {    
        if($this->input->post("username"))
        {
            ...
            $result = $this->AccountModel->getAdmin($username); //Gets ID and password hash of user
	...
	public function logout_user()
    {
		...
		$result = $this->AccountModel->getRemeberMe(); 
		if($result != null)
			$this->AccountModel->deleteRememberMe($customerNumber); 
    ...
    public function createAccount()
    {
        ...
        while($loop == true)
        {
            ...
            if(!$this->AccountModel->if_ID_Exists($customerNumber))
            {
                $loop = false;
            }
        }
        ...
        $result = $this->AccountModel->createAccount($values);
